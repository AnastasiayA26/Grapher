                ...
                <div style={{
                    ...
                    <div style={{display: 'flex', flexWrap: 'wrap'}}>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 0 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('x', 0)} onKeyDown={() => inputRef.current.focus()}>x</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 1 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('y', 1)} onKeyDown={() => inputRef.current.focus()}>y</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 2 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('ln( )', 2)} onKeyDown={() => inputRef.current.focus()}>ln</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 3 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('log(a, x)', 3)} onKeyDown={() => inputRef.current.focus()}>log</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 4 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('cos( )', 4)} onKeyDown={() => inputRef.current.focus()}>cos</button>
                    </div>
                    <div style={{display: 'flex', flexWrap: 'wrap'}}>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 5 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('(', 5)} onKeyDown={() => inputRef.current.focus()}>(</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 6 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick(')', 6)} onKeyDown={() => inputRef.current.focus()}>)</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 7 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('<', 7)} onKeyDown={() => inputRef.current.focus()}>{"<"}</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 8 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('>', 8)} onKeyDown={() => inputRef.current.focus()}>{">"}</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 9 ? '#d3d1d1' : '#ffffff'}} onClick={() => handleKeyClick('sin( )', 9)} onKeyDown={() => inputRef.current.focus()}>sin</button>
                    </div>
                    <div style={{display: 'flex', flexWrap: 'wrap'}}>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 10 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('abs()', 10)} onKeyDown={() => inputRef.current.focus()}>|x|</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 11 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('<=', 11)} onKeyDown={() => inputRef.current.focus()}>≤</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 12 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('>=', 12)} onKeyDown={() => inputRef.current.focus()}>≥</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 13 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('ctg()', 13)} onKeyDown={() => inputRef.current.focus()}>ctg</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 14 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('tan( )', 14)} onKeyDown={() => inputRef.current.focus()}>tan</button>
                    </div>
                    <div style={{display: 'flex', flexWrap: 'wrap'}}>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 15 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('sqrt()', 15)} onKeyDown={() => inputRef.current.focus()}>√</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 16 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('^', 16)} onKeyDown={() => inputRef.current.focus()}>^</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 17 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('e', 17)} onKeyDown={() => inputRef.current.focus()}>e</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 18 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('pi', 18)} onKeyDown={() => inputRef.current.focus()}>π</button>
                        <button style={{ ...buttonStyle, backgroundColor: clickedButtonIndex === 19 ? '#d3d1d1' : '#ffffff'}}
                                onClick={() => handleKeyClick('.', 19)} onKeyDown={() => inputRef.current.focus()}>,</button>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <div style={{display: 'flex', flexWrap: 'wrap'}}>
                        <button
                            ...
                            onClick={() => handleKeyClick('7', 20)} onKeyDown={() => inputRef.current.focus()}>7
                        </button>
                        <button
                            style={{...buttonStyle, backgroundColor: clickedButtonIndex === 21 ? '#d3d1d1' : '#ffffff'}}
                            onClick={() => handleKeyClick('8', 21)} onKeyDown={() => inputRef.current.focus()}>8
                        </button>
                        <button
                            style={{...buttonStyle, backgroundColor: clickedButtonIndex === 22 ? '#d3d1d1' : '#ffffff'}}
                            onClick={() => handleKeyClick('9', 22)} onKeyDown={() => inputRef.current.focus()}>9
                        </button>
                        <button
                            style={{...buttonStyle, backgroundColor: clickedButtonIndex === 23 ? '#d3d1d1' : '#ffffff'}}
                            onClick={handleDelete} onKeyDown={() => inputRef.current.focus()}>⌫
                        </button>
                    </div>

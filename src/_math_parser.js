...
var DATA={
  "parser": {
    ...
    "parser": {
      "tokens": {
        "0": "unary{expr_6,expr_7,OP_6}",
        "1": "lassoc{expr_5,expr_6,OP_5}",
        "2": "expr_others",
        "3": "ID",
        "4": "expr_func_call",
        "5": "lassoc{expr_4,expr_5,OP_4}",
        "6": "expr_4",
        "7": "expr_6",
        "8": "OP_6",
        "9": "number",
        ...
        "28": "expr",
        "29": "expr_1",
        "30": "lassoc{expr_2,expr_3,OP_2}",
        "31": "lassoc{expr_1,expr_2,OP_1}",
        "32": "nonassoc{expr_3,expr_4,OP_3}",
        "33": "lassoc{expr_0,expr_1,OP_0}",
        "34": "__expr_func_call_star_0",
        "35": "start"
      },
      "states": {
        "0": {
